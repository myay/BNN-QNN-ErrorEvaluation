...
def parse_args(parser):
    ...
    parser.add_argument('--weight', type=int, default=4, help='Quantization of weight-bits (default: 4)')
    parser.add_argument('--input', type=int, default=4, help='Quantization of input-bits (default: 4)')
